...
export default function PersonalizedRsvpPage() {
  ...
  if (alreadyUsed && !done) return (
    <div style={{ minHeight: '100vh', background: 'var(--cream)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '2rem' }}>
      ...
      <Link href={`/${slug}/${code}`} style={{ display: 'inline-block', padding: '0.85rem 2rem', background: 'var(--charcoal)', color: 'white', borderRadius: 8, fontFamily: 'Jost, sans-serif', fontSize: '0.72rem', letterSpacing: '0.2em', textTransform: 'uppercase', textDecoration: 'none' }}>
        View Wedding Page
      </Link>
    </div>
  );
  ...
  if (done) return (
    <div style={{ minHeight: '100vh', background: 'var(--cream)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '2rem' }}>
      ...
      <div style={{ maxWidth: 480, width: '100%' }}>
        ...
        <Link href={`/${slug}/${code}`} style={{ display: 'inline-block', padding: '0.85rem 2.5rem', background: 'var(--charcoal)', color: 'white', borderRadius: 8, fontFamily: 'Jost, sans-serif', fontSize: '0.72rem', letterSpacing: '0.2em', textTransform: 'uppercase', textDecoration: 'none' }}>
          View Wedding Page
        </Link>
      </div>
    </div>
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--cream)' }}>
      ...
      <div style={{ paddingTop: '3rem', paddingBottom: '2.5rem', textAlign: 'center', background: 'var(--charcoal)', position: 'relative' }}>
        <Link href={`/${slug}/${code}`} style={{ position: 'absolute', left: '2rem', top: '50%', transform: 'translateY(-50%)', fontFamily: 'Jost, sans-serif', fontSize: '0.6rem', letterSpacing: '0.15em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.4)', textDecoration: 'none' }}>
          ← Back
        </Link>
